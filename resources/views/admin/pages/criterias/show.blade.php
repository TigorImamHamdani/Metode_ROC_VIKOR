                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="criteria_code" id="criteria_code"
                                                class="form-control" placeholder="Masukkan Kode Kriteria"
                                                value="{{ $criteria->criteria_code }}" disabled>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="criteria_name" id="criteria_name"
                                                ...
                                                value="{{ $criteria->criteria_name }}" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="description" class="form-label">Deskripsi</label>
                                            <input type="text" name="description" id="description"
                                                class="form-control" placeholder="Masukkan Deskripsi"
                                                value="{{ $criteria->description }}" disabled>
                                        </div>
